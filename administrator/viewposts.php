				...
				<div class="col-md-4">
					<div class="sec-nvbar">
						<ul>
							...
							<a href="viewposts.php"><li  class="actve">View Posts</li></a>
							...
							<tbody>
								...
								if($r){
									while ($row = mysql_fetch_array($r)) {
										echo "<tr>";
										echo '<td><img src="../postfiles/'.$row['attachedfile'].'" height=40 width=40/></td>';
										echo '<td>'.$row['posttitle'].'</td>';
										echo '<td>'.$row['dateTime'].'</td>';
										echo '<td align="center">'.$row['hitz'].'</td>';
										echo '<td><a href="previewpost.php?id='.$row['postid'].'">&nbsp;&nbsp;&nbsp;<span class="fa fa-file-text-o" style="color:skyblue; text-align:center;"></span></a><br/><a href="editpost.php?id='.$row['postid'].'">&nbsp;&nbsp;&nbsp;<span class="fa fa-pencil" style="color:black; text-align:center;"></span></a><br/><a href="deletepost.php?id='.$row['postid'].'">&nbsp;&nbsp;&nbsp;<span class="fa fa-trash-o" style="color:#f9341e; text-align:center;"></span></a>';
										echo "</tr>";
									}
								}
								?>
	                     ...
	                     echo '<ul class="pagination">
	                        ...
	                        for ($page=1; $page<=$num_of_pages; $page++) { 
	                           //echo '<span><a href="research-papers.php?page='.$page.'" style="border:solid 1px;padding:5px;margin:5px;background-color:skyblue;color:white;"><b>'.$page.'   </b></a></span>';
	                            ...
	                            echo '<li><a href="viewposts.php?page='.$page.'">'.$page.'   </a></li>';
