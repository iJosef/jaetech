			...
			<div class="col-md-12">
				<div class="col-md-4">
					<div class="sec-nvbar">
						<ul>
							...
							<a href="viewprojects.php"><li  class="actve">View Projects</li></a>
				...
				<div class="col-md-8">
					<div class="col-sm-12 col-md-12">
						<h3><b>Uploaded Projects</b></h3><br/><br/>
						<table cellpadding="10px" cellspacing="5px" border="3px" class="table">
							...
							<tbody>
								...
								$sql="SELECT * FROM portfolio ORDER BY portfolioid DESC LIMIT " .$this_page_first_result.','.$results_per_page;
								$r = mysql_query($sql);
								...
								if($r){
									...
									while ($row = mysql_fetch_array($r)) {
										echo "<tr>";
										echo '<td><img src="../uploads/'.$row['photo'].'" height=40 width=40/></td>';
										echo '<td>'.$row['title'].'</td>';
										echo '<td>'.$row['website'].'</td>';
										echo '<td><a href="deletework.php?id='.$row['portfolioid'].'">&nbsp;&nbsp;&nbsp;<span class="fa fa-trash-o" style="color:#f9341e; text-align:center;"></span></a>';
										echo "</tr>";
									}
								}
								?>
	                     ...
	                     echo '<ul class="pagination">
	                        ...
	                        for ($page=1; $page<=$num_of_pages; $page++) { 
	                           //echo '<span><a href="research-papers.php?page='.$page.'" style="border:solid 1px;padding:5px;margin:5px;background-color:skyblue;color:white;"><b>'.$page.'   </b></a></span>';
	                            ...
	                            echo '<li><a href="viewprojects.php?page='.$page.'">'.$page.'   </a></li>';
